...
namespace Lab_3
{
    public partial class Form1 : Form
    {
        ...
        private void open_button_Click(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog(this) == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    {
                        int count = File.ReadAllLines(openFileDialog1.FileName).Length; // кол вершин
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (dataReaded && txtb_StartVertex.Text != "")
            {
                ...
                try
                {
                    ...
                    txb_WriteOnScreenAllPaths.Text = "BFSearch {" + string.Join(", ", algorithms.BFS(graph, 1)) + "}\r\n";
        ...
        private void UpdateRichTxtBoxWithShortestPaths()
        {
            if (dataReaded)
            {
                ...
                for (int i = 0; i < edges.Length; i++)
                {
                    txtb_AllVertexes.Text += $"{{ {edges[i].Item1} }}; ";
                }
            }
            return;
        }
